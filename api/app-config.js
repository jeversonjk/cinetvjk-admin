// /api/app-config.js — GET e PATCH configuração do app (CommonJS + Supabase)
...
function toConfig(d) {
  return { backgroundUrl: d.background_url || "", epgUrl: d.epg_url || "" };
}
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === "PATCH") {
      const { backgroundUrl, epgUrl } = req.body || {};
